...
const WAREHOUSE_FROM_PHRASE_KA: Record<string, string> = {
  uk: 'დიდი ბრიტანეთის საწყობიდან',
  us: 'აშშ-ის საწყობიდან',
  cn: 'ჩინეთის საწყობიდან',
  it: 'იტალიის საწყობიდან',
  gr: 'საბერძნეთის საწყობიდან',
  es: 'ესპანეთის საწყობიდან',
  fr: 'საფრანგეთის საწყობიდან',
  de: 'გერმანიის საწყობიდან',
  tr: 'თურქეთის საწყობიდან',
};
